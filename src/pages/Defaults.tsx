...
function Defaults() {
  return (
    <>
      <header className="pl-11 pb-5 pt-10">
        <div className="mx-auto max-w-7xl pt-6 px-4 sm:px-6 lg:px-8">
          <p className="text-md font-medium primary-header">Defaulters</p>
        </div>
      </header>
      <main>
        <div className="flex flew-row pl-10  px-4 sm:px-6 lg:px-8 justify-center">
          <div className="flex justify-center">
            <DefaultCard
              data={{
                heading: "Total default amount (NGN)",
                value: "3,160,010",
                image: "dollar_d.png",
              }}
            ></DefaultCard>
            ...
            <DefaultCard
              data={{
                heading: "Total number of defaulters",
                value: "316",
        ...
        <div className="flex flew-row pl-20 pr-20 pt-8 sm:px-6 lg:px-8 ml-11 justify-between mr-20">
          <div className="flex flex-wrap items-stretch mb-4 relative w-96">
            <div className="flex">
                    ...
                    <tr className="hover:bg-gray-100 dark:hover:bg-gray-700">
                      ...
                      <td className="py-4 px-6 text-sm font-medium text-gray-900 whitespace-nowrap dark:text-white">
                        <span
                          ...
                          className="px-4 py-2 rounded-full font-semibold text-sm flex align-center w-max cursor-pointer active:bg-gray-300 transition duration-300 ease"
                        >
                          <p
                            className="text-md font-medium "
                            style={{
        ...
        <div className="flex flew-row pl-20 pr-20 pt-8 sm:px-6 lg:px-8 ml-11 justify-center mr-20 mb-3">
          <div className="flex justify-center">
            <nav aria-label="Page navigation example">
              <ul className="flex list-style-none">
                ...
                <li className="page-item mr-2">
                  <a
                   style={{fontWeight:500, color:"#101010", fontSize:"14px"}}
                ...
                <li className="page-item active mr-2">
                  ...
                  style={{ backgroundColor: "#EAEAEA",fontWeight:500, color:"#101010", fontSize:"14px"}}
                    className="page-link relative block py-1.5 px-3 rounded border-0  outline-none transition-all duration-300 rounded hover:text-white "
