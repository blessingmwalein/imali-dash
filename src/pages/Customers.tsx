...
import { CustomerCardModel } from "./models/Cards";
import { CustomerModel, customers } from "./models/Customer";

var customerCards: CustomerCardModel[] = [
  {
    percentage: "40",
  ...
  {
    percentage: "10",
    heading: "Total active customers",
    value: "1,210",
    isIncrease: false,
  },
  {
    percentage: "40",
    heading: "Total defaulters",
    value: "316",
    isIncrease: true,
  },
];
    ...
    <>
      <header className="pl-11 pb-5 pt-10">
        <div className="mx-auto max-w-7xl pt-6 px-4 sm:px-6 lg:px-8">
          <p className="text-md font-medium primary-header">Customers</p>
        </div>
      </header>
      <main>
        <div className="flex flew-row pl-10  px-4 sm:px-6 lg:px-8 justify-center">
          <div className="flex justify-center">
            {customerCards.map((card: any, index) => (
              <CustomerCard key={index} data={card} />
            ))}
          </div>
        </div>
        ...
        <div className="flex flew-row pl-20 pr-20 pt-8 sm:px-6 lg:px-8 ml-11 justify-between mr-20 mb-5">
                ...
                <table className="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-700">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                    {customers.map((customer: CustomerModel) => (
                      <tr className="hover:bg-gray-100 dark:hover:bg-gray-700" key={customer.id}>
